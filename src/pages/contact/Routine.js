          ...
          <div className="routine__content">
            <div className="routine__left">
              ...
              <span className="left__content">
                ...
                personalized product picks that fit your lifestyle and skin
                goals.
              </span>
              <Link to="/pages/skin-quiz" className="routine__left__btn">
                Building Your Routine
              </Link>
              <p className="left__contentbot">
                This website uses cookies. By continuing to browse this site,
                you agree to our use of cookies. Read our Cookie Policy.
              </p>
            </div>
